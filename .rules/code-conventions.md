...
## 测试策略
- 当前仓库的测试代码禁令与允许验证方式统一遵守测试与验证强制规则。
- 常规任务不得为了验证问题而新增或修改单元测试、集成测试、E2E 测试、测试脚本、fixture 或 mock 文件。
- 需要验证核心业务逻辑、模块交互、关键用户流程或性能风险时，优先使用测试与验证强制规则允许的现有命令、本地手工验证、日志观察或一次性不落盘命令行检查。
